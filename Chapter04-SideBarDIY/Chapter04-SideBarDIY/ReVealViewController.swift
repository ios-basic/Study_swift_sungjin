...
class ReVealViewController: UIViewController {
    ...
    func getSideView() {
        ...
        // 2. 다른 메소드에서도 참조할 수 있도록 sideVC 속성에 저장
        self.sideVC = vc
        ...
        // 4. _프론트 컨트롤러에 부모 뷰 컨트롤러가 바뀌었음을 알려줌
        vc.didMove(toParent: self)
        
        // 5. _프론트 컨트롤러의 뷰를 제일 위로 올림
    ...
    func openSideBar(_ complete: ( () -> Void)?) {
        ...
        // 3. 애니메이션 실행
        UIView.animate(withDuration: TimeInterval(self.SLIDE_TIME), delay: TimeInterval(0),
                       options: options,
