...
class ViewController: UIViewController {
    ...
    func initTitleInput() {
        ...
        tf.backgroundColor = .white // 배경 색상을 흰색
        tf.font = UIFont.systemFont(ofSize: 13) // 입력할 글씨 크기를 13픽셀로
        tf.autocapitalizationType = .none // 자동 대문자 변환 속성은 사용안함
        ...
        // 좌측 바 영역
//        let v = UIView()
//        v.frame = CGRect(x: 0, y: 0, width: 0150, height: 37)
...
//        self.navigationItem.rightBarButtonItem = rightItem
    ...
    func initTitle() {
        ...
        nTitle.textColor = .white // 텍스트 색상
        nTitle.font = UIFont.systemFont(ofSize: 15) // 폰트 사이즈
        nTitle.text = "58개 숙소 \n 1박(1월 10일 ~ 1월 11일)"
    ...
    func initTitleNew() {
        ...
        // 4. 상하단 레이블을 컨테이너 뷰에 추가
        containerView.addSubview(topTitle)
        containerView.addSubview(subTitle)
        
        // 5. 내비게이션 타이틀에 컨테이너 뷰를 대입
