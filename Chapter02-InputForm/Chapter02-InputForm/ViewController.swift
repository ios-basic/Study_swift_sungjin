...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.paramEmail.autocapitalizationType = .none // 첫글자 대문자 자동 변환 기능을 해제
        ...
        self.txtUpdate.textColor = UIColor.red // 1. 텍스트의 색상 설정 빨강
        self.txtUpdate.text = "갱신함" // 2. "갱산힘" or "갱신하지 않음"
